...
EOF
  ...
  sleep 3;
  $HELPER -S --needed awesome-git lightdm lightdm-webkit2-greeter neovim librewolf-bin nautilus gd rofi ttf-roboto \
...
EOF
  ...
  sleep 3;
  git clone https://github.com/sajayprakash/awesomewm-dotfiles /tmp/dotfiles
  cd /tmp/dotfiles/
